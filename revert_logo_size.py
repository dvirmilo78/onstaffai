...
if manifest_match:
    ...
    if app_uuid in manifest:
        ...
        # Replace 85px height with 125px
        old_brand = '<img src="assets/onstaff_logo.png" alt="OnStaffAI" style={{height: "85px"'
        new_brand = '<img src="assets/onstaff_logo.png" alt="OnStaffAI" style={{height: "125px"'
        
        if old_brand in text:
            text = text.replace(old_brand, new_brand)
        else:
            text = text.replace('height: "85px"', 'height: "125px"')
...
idx_html = idx_html.replace('height: 85px;', 'height: 125px;')

with open('index.html', 'w', encoding='utf-8') as out:
    out.write(idx_html)

print("Successfully enlarged logo back to 125px.")
