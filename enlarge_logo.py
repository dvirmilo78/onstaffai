...
if manifest_match:
    ...
    if app_uuid in manifest:
        ...
        # Replace the 50px height with 125px
        old_brand = '<img src="assets/onstaff_logo.png" alt="OnStaffAI" style={{height: "50px"'
        ...
        if old_brand in text:
            ...
            text = text.replace('height: "50px"', 'height: "125px"')
...
idx_html = idx_html.replace('height: 50px;', 'height: 125px;')

with open('index.html', 'w', encoding='utf-8') as out:
    out.write(idx_html)

print("Successfully enlarged logo.")
